...
//            self?.navigationController?.popViewController(animated: true)
        ...
        navigationView.filterButtonTappedHandler = { [weak self] in
            let v = FilterViewController(datasource: [UILabel()])
...
class FilterViewController: UIViewController {
    ...
    required init(datasource: [AnyObject]) {
...
//        collectionView.delegate = self
        ...
        applyButton.heightAnchor.constraint(equalToConstant: 64.0).isActive = true
        applyButton.widthAnchor.constraint(equalToConstant: 208.0).isActive = true
        applyButton.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -56).isActive = true
